...
/**
 * Creates new instance of 'PeerToPeerConnection'.
 *
 ...
 *
 * FIXME: initially the purpose of PeerToPeerConnection was to be able to
 ...
 * @constructor
 */
export default function PeerToPeerConnection(
        rtc,
        id,
        signalingLayer,
        iceConfig,
 ...
 * @private
 */
PeerToPeerConnection.prototype._processStat
 ...
 * @return {string}
 */
PeerToPeerConnection.prototype.getConnectionState = function() {
 ...
 * @private
 */
PeerToPeerConnection.prototype._getDesiredMediaDirection = function(
        mediaType) {
 ...
 */
PeerToPeerConnection.prototype.isSimulcastOn = function() {
 ...
 * @private
 */
PeerToPeerConnection.prototype._peerVideoTypeChanged = function(
        endpointId,
        videoType) {
 ...
 * @private
 */
PeerToPeerConnection.prototype._peerMutedChanged = function(
        endpointId,
        mediaType,
        isMuted) {
 ...
 */
PeerToPeerConnection.prototype.getLocalTracks = function(mediaType) {
...
/**
 * Checks whether or not this {@link PeerToPeerConnection} instance contains
 * any local tracks for given <tt>mediaType</tt>.
 * @param {MediaType} mediaType
 * @return {boolean}
 */
PeerToPeerConnection.prototype.hasAnyTracksOfType = function(mediaType) {
    if (!mediaType) {
 ...
 */
PeerToPeerConnection.prototype.getRemoteTracks = function(
        endpointId,
        mediaType) {
    const remoteTracks = [];
    const endpoints
 ...
 */
PeerToPeerConnection.prototype.getTrackBySSRC = function(ssrc) {
 ...
 * @return {number|null}
 */
PeerToPeerConnection.prototype.getSsrcByTrackId = function(id) {
 ...
 */
PeerToPeerConnection.prototype._remoteStreamAdded = function(stream) {
 ...
 * participant
 */
PeerToPeerConnection.prototype._remoteTrackAdded = function(stream, track) {
    const streamId = RTC.getStreamID(stream);
 ...
 */
PeerToPeerConnection.prototype._createRemoteTrack = function(
        ownerEndpointId,
        stream,
        track,
        mediaType,
 ...
 * PeerConnection
 */
PeerToPeerConnection.prototype._remoteStreamRemoved = function(stream) {
 ...
 */
PeerToPeerConnection.prototype._remoteTrackRemoved = function(
        stream,
        track) {
    const streamId = RTC.getStreamID(stream);
 ...
 * @private
 */
PeerToPeerConnection.prototype._getRemoteTrackById = function(
        streamId,
        trackId) {
 ...
 */
PeerToPeerConnection.prototype.removeRemoteTracks = function(owner) {
    const removedTracks = [];
 ...
 */
PeerToPeerConnection.prototype._removeRemoteTrack = function(toBeRemoved) {
    toBeRemoved.dispose();
 ...
 * found.
 */
PeerToPeerConnection.prototype._removeRemoteTrackById = function(
        streamId,
        trackId) {
 ...
 */
PeerToPeerConnection.prototype.getLocalSSRC = function(localTrack) {
 ...
 */
PeerToPeerConnection.prototype._injectSsrcGroupForUnifiedSimulcast
    = function(desc) {
...
Object.keys(getters).forEach(prop => {
    Object.defineProperty(
        PeerToPeerConnection.prototype,
        prop, {
            get: getters[prop]
        }
    );
...
PeerToPeerConnection.prototype._getSSRC = function(rtcId) {
 ...
 */
PeerToPeerConnection.prototype.addTrack = function(track) {
 ...
 */
PeerToPeerConnection.prototype.addTrackUnmute = function(track) {
 ...
 * @private
 */
PeerToPeerConnection.prototype._addStream = function(mediaStream) {
 ...
 * @param {MediaStream} mediaStream
 */
PeerToPeerConnection.prototype._removeStream = function(mediaStream) {
 ...
 * @private
 */
PeerToPeerConnection.prototype._assertTrackBelongs = function(
        methodName,
        localTrack) {
 ...
 * @returns {boolean}
 */
PeerToPeerConnection.prototype.isMediaStreamInPc = function(mediaStream) {
 ...
 */
PeerToPeerConnection.prototype.removeTrack = function(localTrack) {
 ...
 * was found.
 */
PeerToPeerConnection.prototype.findSenderByKind = function(mediaType) {
 ...
 * was found.
 */
PeerToPeerConnection.prototype.findSenderByStream = function(stream) {
 ...
 */
PeerToPeerConnection.prototype.replaceTrack = function(oldTrack, newTrack) {
 ...
 */
PeerToPeerConnection.prototype.replaceTrackWithoutOfferAnswer = function(localTrack) {
 ...
 */
PeerToPeerConnection.prototype.removeTrackMute = function(localTrack) {
    const webRtcStream = localTrack.getOriginalStream();
 ...
 */
PeerToPeerConnection.prototype._handleSenderRemoveStream = function(
        stream) {
    if (!stream) {
...
PeerToPeerConnection.prototype.createDataChannel = function(label, opts) {
 ...
 * @private
 */
PeerToPeerConnection.prototype._ensureSimulcastGroupIsLast = function(
        localSdp) {
 ...
 * @private
 */
PeerToPeerConnection.prototype._adjustLocalMediaDirection = function(
        localDescription) {
    const transformer = new SdpTransformWrap(localDescription.sdp);
...
PeerToPeerConnection.prototype.setLocalDescription = function(description) {
 ...
 * @public
 */
PeerToPeerConnection.prototype.setAudioTransferActive = function(active) {
 ...
 */
PeerToPeerConnection.prototype._insertUnifiedPlanSimulcastReceive
    = function(desc) {
        const sdp = transform.parse(desc.sdp);
        const video = sdp.media.find(mline => mline.type === 'video');
 ...
 */
PeerToPeerConnection.prototype.setMaxBitRate = function(localTrack) {
...
PeerToPeerConnection.prototype.setRemoteDescription = function(description) {
 ...
 */
PeerToPeerConnection.prototype._injectH264IfNotPresent = function(
        description) {
    const parsedSdp = transform.parse(description.sdp);
    const videoMLine = parsedSdp.media.find(m => m.type === 'video');
 ...
 * @public
 */
PeerToPeerConnection.prototype.setVideoTransferActive = function(active) {
 ...
 * @returns {void}
 */
PeerToPeerConnection.prototype.sendTones = function(tones, duration = 200, interToneGap = 200) {
    if (!this._dtmfSender) {
        if (this.peerconnection.getSenders) {
 ...
 * @returns {void}
 */
PeerToPeerConnection.prototype._onToneChange = function(event) {
...
/**
 * Makes the underlying PeerToPeerConnection generate new SSRC for
 * the recvonly video stream.
 */
PeerToPeerConnection.prototype.generateRecvonlySsrc = function() {
...
/**
 * Makes the underlying PeerToPeerConnection forget the current primary video
 * SSRC.
 */
PeerToPeerConnection.prototype.clearRecvonlySsrc = function() {
 ...
 * them.
 */
PeerToPeerConnection.prototype.close = function() {
    this.trace('stop');
...
PeerToPeerConnection.prototype.createAnswer = function(constraints) {
...
PeerToPeerConnection.prototype.createOffer = function(constraints) {
    return this._createOfferOrAnswer(true /* offer */, constraints);
};

/**
 * Checks if a camera track has been added to the peerconnection
 * @param {PeerToPeerConnection} peerConnection
...
PeerToPeerConnection.prototype._createOfferOrAnswer = function(
        isOffer,
        constraints) {
 ...
 * currently stored in the {@link PeerToPeerConnection.localSSRCs} map.
 * @param {Map<string,TrackSSRCInfo>} ssrcMap
 * @private
 */
PeerToPeerConnection.prototype._processLocalSSRCsMap = function(ssrcMap) {
...
PeerToPeerConnection.prototype.addIceCandidate = function(candidate) {
 ...
 * @returns {void}
 */
PeerToPeerConnection.prototype.getStats = function(callback, errback) {
 ...
 * @return {TPCSSRCInfo}
 */
PeerToPeerConnection.prototype.generateNewStreamSSRCInfo = function(track) {
    const rtcId = track.rtcId;
 ...
 */
PeerToPeerConnection.prototype.setIsSelected = function(isSelected) {
...
/**
 * Creates a text representation of this <tt>PeerToPeerConnection</tt>
 * instance.
 * @return {string}
 */
PeerToPeerConnection.prototype.toString = function() {
