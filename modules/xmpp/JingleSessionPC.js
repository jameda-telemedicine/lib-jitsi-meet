...
export default class JingleSessionPC extends JingleSession {
    ...
    doInitialize(options) {
        ...
        /**
         * The negotiationneeded event is fired whenever we shake the media at the
    ...
    sendIceCandidate(candidate) {
        ...
        if (candidate && candidate.candidate !== '' && !this.lasticecandidate) {
            const ice
                = SDPUtil.iceparams(
        ...
        const workFunction = finishedCallback => {
            ...
            if (localTracks) {
                for (const track of localTracks) {
                    this.peerconnection.addTrack(track, false);
                }
            }
            const newRemoteSdp
    ...
    _initiatorRenegotiate(remoteDescription) {
        ...
        return this.peerconnection.createOffer(this.mediaConstraints)
            .then(offer => {
                logger.debug(`Renegotiate: setting local description as ${offer.sdp}`);
